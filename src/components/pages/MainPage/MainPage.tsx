...
import {getCategoryAll,  getVendorAll , postSubCategory,  getAllVendorLocation} from "../../../http/filtersApi"
const MainPage = () => {
    ...
    useEffect(()=>{
        ...
        // postSubCategory({name:"sushi"},"081d305e-3a10-4f1f-9a14-80e44ff4eca9").then(resolve=> {console.log(resolve) })
